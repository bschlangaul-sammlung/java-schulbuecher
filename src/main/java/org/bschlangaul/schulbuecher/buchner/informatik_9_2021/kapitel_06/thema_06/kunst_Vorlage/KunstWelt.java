...
public class KunstWelt extends World
{
    ...
    {
        super(15, 15, 50);
        erstelleKunstwerk(); // ruft die Methode auf, die alle Kunstwerke erstellen soll
    }
    ...
    void erstelleQuadratAn(int x, int y) // zeichnet ein farbiges Quadrat an der Stelle (x|y)
    {
