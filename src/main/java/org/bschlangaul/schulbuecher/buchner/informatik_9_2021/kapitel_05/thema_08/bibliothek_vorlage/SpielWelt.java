...
public class SpielWelt extends World
{
    public SpielWelt()
    {
        ...
        Buch buch1 = new Buch("Informatik leicht gemacht", "A. B. Zeh", 2.99 + rng.nextInt(20));
        addObject(buch1, 100, 150);

        Buch buch2 = new Buch("Der Doppelklick", "D. Maus", 2.99 + rng.nextInt(20));
        addObject(buch2, 300, 150);

        Buch buch3 = new Buch("Die Insel Java", "K. Fee", 2.99 + rng.nextInt(20));
