...
public class Tierwelt extends World
{
    ...
    {
        super(10, 6, 60);
        // erzeugt ein Objekt der Klasse Tier und fügt es an der Stelle (1|1) ein
        addObject(new Tier(), 1, 1);

        // erzeugt ein Objekt der Klasse Biene und fügt es an der Stelle (3|3) ein
        addObject(new Biene(), 3, 3);
        // erzeugt ein Objekt der Klasse Eisbaer und fügt es an der Stelle (5|2) ein
