...
public class Baerenwelt extends World
{
    ...
    /*
     * Erzeugt die Welt, färbt den Hintergrund und platziert ein Bären-Objekt unten in die Mitte.
     */
    public Baerenwelt()
    {
        super(800, 600, 1);
    ...
    public void act()
    {
        erzeugeMitWahrscheinlichkeit(0.01, new Salat());
        erzeugeMitWahrscheinlichkeit(0.01, new Pizza());
        erzeugeMitWahrscheinlichkeit(0.01, new Apfel());
        erzeugeMitWahrscheinlichkeit(0.01, new Batterie());
        erzeugeMitWahrscheinlichkeit(0.01, new Tasche());
        erzeugeMitWahrscheinlichkeit(0.01, new Werkzeug());
    }
