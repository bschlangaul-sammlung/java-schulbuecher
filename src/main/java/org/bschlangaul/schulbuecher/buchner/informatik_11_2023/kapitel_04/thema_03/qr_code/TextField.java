...
public class TextField extends Actor
{
    ...
    /**
     * Creates a new TextField of a default size of 250 x 50 with black letters
     * on white background.
     */
    public TextField()
    {
    ...
    /**
     * Creates a new TextField with a default size of 250 x 50 with black
     * letters on white background and a starting text.
     *
     * @param text The text that is shown directly.
     */
     ...
     * @param text    The text that is shown directly.
     *
     * @param enabled If you want the textfield to be enabled (able to write in
     *                it) this boolean has to be true.
     */
    ...
    /**
     * Creates a new TextField of the given size with black letters on white
     * background.
     *
     * @param width  The TextFields width (which has to be greater than 50).
     *
     * @param height The TextFields height (which has to be greater than 20).
     */
     ...
     *                it) this boolean has to be true.
     */
    public TextField(int width, int height, boolean enabled)
    ...
    /**
     * Creates a new TextField of the given size with black letters on white
     * background and a starting text.
     *
     * @param width  The TextFields width (which has to be greater than 50).
     *
     * @param height The TextFields height (which has to be greater than 20).
     ...
     * background and a starting text.
     *
     * @param width           The TextFields width (which has to be greater than
     *                        50).
     *
     * @param height          The TextFields height (which has to be greater
     *                        than 20).
     *
     * @param displayKeyNames If you want to use the textfield for only one key
     *                        this parameter has to be true.
     *
     * @param text            The text that is shown directly.
     */
    public TextField(int width, int height, boolean displayKeyNames,
            String text) throws IllegalArgumentException
    {
        this(width, height, displayKeyNames, true, Color.WHITE, Color.BLACK,
                text);
    }
     ...
     * @param height    The TextFields height (which has to be greater than 20).
     *
     * @param bgColor   The color of the TextFields background.
     *
     * @param textColor The color of the text.
     */
    public TextField(int width, int height, Color bgColor, Color textColor)
            throws IllegalArgumentException
    {
     ...
     */
    public TextField(int width, int height, boolean displayKeyNames,
            Color bgColor, Color textColor) throws IllegalArgumentException
    {
        this(width, height, false, true, bgColor, textColor, "");
    }

    /**
     * Creates a new TextField of the given size, the given colors and a
     * starting text.
     *
     * @param width     The TextFields width (which has to be greater than 50).
     *
     ...
     *                        this parameter has to be true.
     *
     * @param enabled         If you want the textfield to be enabled (able to
     *                        write in it) this boolean has to be true.
     *
     * @param bgColor         The color of the TextFields background.
     *
     * @param textColor       The color of the text.
     */
    public TextField(int width, int height, boolean displayKeyNames,
            boolean enabled, Color bgColor, Color textColor, String text)
            throws IllegalArgumentException
    {
        if (width < 50)
        {
            throw new IllegalArgumentException(
                    "The width of the text field has to be greater or equal 50");
        }
        else if (height < 20)
        {
            throw new IllegalArgumentException(
                    "The height of the text field has to be greater or equal 20");
        }
    ...
    /**
     * Assigns this field a number. This method is called when the object is
     * added to the world.
     */
    ...
    public void act()
    {
        ...
        if (active)
        {
            ...
            if (enabled)
            {
                ...
                {
                    if (input == "backspace" && text.length() != 0
                            && cursorPosition != 0)
                    {
    ...
    {
        GreenfootImage textImage = new GreenfootImage(text, textFontSize,
                textColor, new Color(0, 0, 0, 0));
        GreenfootImage textBeforeCursor = new GreenfootImage(
                text.substring(0, cursorPosition), textFontSize, textColor,
                new Color(0, 0, 0, 0));
        resetImage();
     ...
     *
     * @param activeTextField The number of the TextField that is activated.
     */
    ...
    /**
     * Check whether this textfield is enabled (if you can change the text in
     * it).
     *
     * @return Returns true if the text field is enabled.
     */
     ...
     *
     * @return The text that is currently displayed in the textfield.
     */
     ...
     *
     * @param text The text that should be displayed in the textfield.
     */
     ...
     *
     * @return The backgroundcolor of this TextField.
     */
     ...
     *
     * @param bgColor The new backgroundcolor.
     */
     ...
     *
     * @return The textcolor of this TextField.
     */
