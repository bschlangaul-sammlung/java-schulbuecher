package org.bschlangaul.schulbuecher.buchner.informatik_11_2023.kapitel_03.thema_05.bahnhoefe;
/**
...
public class GRAPH
{
    ...
    public void breitensuche_2b(String start, String ende) {
        ...
        for(int i=0; i<maxAnzahl; i++) {
            if(knotennamen[i].bezeichnerIstGleich(start)) { indexStart=i;}
            if(knotennamen[i].bezeichnerIstGleich(ende)) { indexEnde=i;}
        }
        ...
        warteschlange[0]=indexStart; //Der Start-Knoten wird als 1. abzuarbeitender Knoten abgespeichert.
