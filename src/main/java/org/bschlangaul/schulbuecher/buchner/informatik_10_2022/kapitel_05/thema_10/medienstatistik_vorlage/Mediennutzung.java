...
public class Mediennutzung
{
    ...
    public Mediennutzung(int anzahlSchueler10A, int anzahlSchueler10B, int anzahlSchueler10C)
    {
        ...
        this.klassenverbund = new double[this.medien10A.length + this.medien10B.length
                        + this.medien10C.length];
