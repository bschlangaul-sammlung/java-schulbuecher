package org.bschlangaul.schulbuecher.buchner.informatik_10_2022.kapitel_05.thema_02.schule_vorlage;

/**
 * Klasse zur Darstellung einer Schulklasse mit Bezeichnung, Schülerliste und den
 * Notendurchschnitten für die einzelnen Fächer
 */
public class Schulklasse
{
    ...
    public Schulklasse(String bezeichnung)
    {
        ...
        /*
         * Bearbeitung Aufgabe A3a) Schueler fritz = new Schueler("Fritz Feld"); schuelerliste[6] =
         * fritz; Schueler anna = new Schueler("Anna Array"); schuelerliste[8] = anna;
         *
         * Bearbeitung Aufgabe A3b) System.out.println(schuelerliste[7].nenneName());
         *
         * Bearbeitung Aufgabe A3c) System.out.println(schuelerliste.length);
         *
         */
