...
public class Schulklasse
{
    ...
    public Schulklasse(String bezeichnung)
    {
        ...
        /*
         * Bearbeitung Aufgabe A3a) Schueler fritz = new Schueler("Fritz Feld");
         * schuelerliste[6] = fritz; Schueler anna = new Schueler("Anna Array");
         * schuelerliste[8] = anna; Bearbeitung Aufgabe A3b)
         * System.out.println(schuelerliste[7].nenneName()); Bearbeitung Aufgabe
         * A3c) System.out.println(schuelerliste.length);
         */
    }
}
