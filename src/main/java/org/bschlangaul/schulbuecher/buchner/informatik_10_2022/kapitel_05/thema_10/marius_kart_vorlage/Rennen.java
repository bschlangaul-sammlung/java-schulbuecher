...
/**
 * Klasse zur Darstellung eines Rennens zwischen maximal 8 Spielern in Marius-Kart
 */
public class Rennen
{
    private String name;
...

    {
        ...
        teilnehmer[0] = new Spieler("Mario", new Gefaehrt("Go-Kart", "rot"), "Geschwindigkeit");
        teilnehmer[1] = new Spieler("Luigi", new Gefaehrt("Cruiser", "grün"), "Geschwindigkeit");
        teilnehmer[2] = new Spieler("Princess", new Gefaehrt("Limousine", "rosa"), "Wendigkeit");
        teilnehmer[3] = new Spieler("Bobba", new Gefaehrt("Monstertruck", "schwarz"), "Stärke");
