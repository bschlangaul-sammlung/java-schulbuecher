...
public class Vortragsabend
{
    ...
    public Vortragsabend()
    {
        ...
        vortragende[0] = new Schueler("Klara", 10, new Instrument("Geige"), standardMusiklehrer);
        vortragende[1] = new Schueler("Benedikt", 7, new Instrument("Schlagzeug"),
        ...
        vortragende[3] = new Schueler("Levin", 15, new Instrument("Posaune"),
                        bassinstrumenteLehrer);
        vortragende[4] = new Schueler("Julia", 17, new Instrument("Cello"), bassinstrumenteLehrer);
        vortragende[5] = new Schueler("Jens", 13, new Instrument("Kontrabass"),
                        bassinstrumenteLehrer);
        vortragende[6] = new Schueler("Mike", 14, new Instrument("Klavier"), standardMusiklehrer);
        vortragende[7] = new Schueler("Marina", 9, new Instrument("Querflöte"),
                        bassinstrumenteLehrer);
        vortragende[8] = new Schueler("Yasser", 6, new Instrument("Gitarre"), standardMusiklehrer);
        vortragende[9] = new Schueler("Janina", 12, new Instrument("Geige"), standardMusiklehrer);
    }
