...
public class Canvas
{
    ...
    // shape identity and colors) is slightly more complex than necessary. Thsis
    ...
    public static Canvas getCanvas()
    {
        ...
        {
            canvasSingleton = new Canvas("BlueJ Picture Demo", 800, 600, // sv:
                                                                         // war
                                                                         // 500,300
                    Color.white);
        }
    ...
    public void setForegroundColor(String colorString)
    {
        ...
        else if (colorString.equals("weiss"))
        {
