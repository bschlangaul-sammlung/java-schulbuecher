...
public class RECHTECK extends Rechteck
{
    ...
    /**
     * Konstruktor der Klasse {@code RECHTECK}. Erstellt ein neues
     * Standard-Rechteck.
     */
    public RECHTECK()
    {
    ...
    /**
     * Konstruktor der Klasse {@code RECHTECK}. Erstellt ein neues Rechteck mit
     * gegebenen Massen.
     *
     ...
     *     koennen in der Readme.txt im BlueJ-Projekt nachgelesen werden.
     */
     ...
     *     dieser Methode dieses Rechteck sichtbar. Ist dieser Wert
     *     {@code false}, so ist nach dem Aufruf dieser Methode dieses Rechteck
     *     unsichtbar.
     */
     ...
     *     EduActor in x-Richtung (>0, wenn dieses Rechteck rechts des anderen
     *     EduActors liegt)
     */
     ...
     *     y-Richtung (>0, wenn dieses Rechteck unterhalb des anderen EduActors
     *     liegt)
     */
