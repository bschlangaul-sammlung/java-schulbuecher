package org.bschlangaul.schulbuecher.cornelsen.informatik_3_2021.kapitel_04.thema_projekt.aufgabe_4.ball_animiert;
 ...
 *
 * @version 4.0 Umstieg auf EA 4 Nicht vergleichbar mit alter Klasse FIGUR (kein
 *     Figuren-Editor mehr). Vereint die alten Klassen FIGUR, BILD und
 *     WECHSELBILD. Kann ein Bild, mehrere Bilder, Sprite-Sheets und animierte
 *     GIFs einlesen.
 */
public class FIGUR extends Figur
{
     ...
     * @param gifPfad Datei-Pfad zu einem animierten GIF. (Liegt dieses direkt
     *     im Projekt-Ordner, so reicht der Datei-Name)
     */
     ...
     *     dieses direkt im Projekt-Ordner, so reicht der Datei-Name)
     ...
     *
     * @param skalierungsFaktor 1 : normal ; 0&lt;skalierungsfaktor&lt;1 :
     *     kleiner ; &gt;1 : groesser
     */
     ...
     *     Hintergrund) , 1=weiter vorne (ueberdeckt Hintergrund und Ebene 0) ;
     *     ...
     */
     ...
     *
     * @param zustandName Name des Zustands, dessen Animationsgeschwindigkeit
     *     man aendern moechte
     ...
     *     Drehsinn (gegen den Uhrzeigersinn) -: mathematisch negativer Drehsinn
     *     (im Uhrzeigersinn)
     */
     ...
     * @param zustandsName Frei waehlbarer Name des Zustands. (Wird zum
     *     Umschalten verwendet)
     * @param bildpfad Pfad zum Spritesheet. (Liegt diese im Projekt-Ordner, so
     *     reicht der Datei-Name)
     ...
     * @param zustandsName Frei waehlbarer Name des Zustands. (Wird zum
     *     Umschalten verwendet)
     * @param verzeichnis Der Name des Ordners (innerhalb des BlueJ-Projekts) in
     *     dem die Bilder liegen
     * @param praefix gemeinsamer Namensbestandteil: z.B. "affe" fuer affe1.jpg,
     *     affe2.jpg, ...
     */
     ...
     *     uebergehen soll, nachdem die animation des ersten Zustands einmal bis
     *     zum Ende durchgelaufen ist.
     */
