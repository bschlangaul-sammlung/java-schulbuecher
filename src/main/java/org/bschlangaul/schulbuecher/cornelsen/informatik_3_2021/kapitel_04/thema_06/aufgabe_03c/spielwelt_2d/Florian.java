package org.bschlangaul.schulbuecher.cornelsen.informatik_3_2021.kapitel_04.thema_06.aufgabe_03c.spielwelt_2d;
...
class Florian extends Figur
{
    ...
    void Gehen()
    {
        ...
        {
            PositionSetzen(25, 475);
        }
        else if (XPositionGeben() == 475 && YPositionGeben() == 475)
        {
            PositionSetzen(25, 25);
        }
    }
