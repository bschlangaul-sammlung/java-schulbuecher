package org.bschlangaul.schulbuecher.cornelsen.informatik_3_2021.kapitel_04.thema_08.aufgabe_A10b.spielwelt_2d;
...
class Florian extends Figur
{
    ...
    void Gehen()
    {
        ...
        if (Berührt("grau"))
        {
            PositionSetzen(posX, posY);
            schritte = schritte + 2; // Strafpunkte
        }
    }
