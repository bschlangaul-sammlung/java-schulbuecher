...
public class KREIS extends Kreis
{
    ...
    /**
     * Konstruktor der Klasse {@code KREIS}. Erstellt einen neuen
     * Standard-Kreis.
     */
    public KREIS()
    {
    ...
    /**
     * Konstruktor der Klasse {@code KREIS}. Erstellt einen neuen Kreis mit
     ...
     *     dieser Methode dieser Kreis sichtbar. Ist dieser Wert {@code false},
     *     so ist nach dem Aufruf dieser Methode dieser Kreis unsichtbar.
     */
     ...
     *     den Uhrzeigersinn) -: mathematisch negativer Drehsinn (im
     *     Uhrzeigersinn)
     */
