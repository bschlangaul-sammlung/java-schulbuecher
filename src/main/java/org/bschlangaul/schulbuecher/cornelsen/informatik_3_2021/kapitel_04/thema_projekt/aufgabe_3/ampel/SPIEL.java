        ...
        MausKlickReagierbar, MausRadReagierbar, BildAktualisierungReagierbar
{
     ...
     * @param maus true : man sieht den Mauszeiger (Klick-Spiel) false : man
     *     sieht ihn nicht (reines Tastatur-Spiel)
     */
     ...
     * Methode starteTickerNeu(double sekunden) wiedergestartet werden.
     *
     * @see SPIEL#starteTickerNeu(double)
     * @see SPIEL#setzeTickerintervall(double)
     *
     */
     ...
     *     Details koennen im ENUM-Typen der <b>Klasse TASTE</b> nachgelesen
     *     werden.
     *
     ...
     * aufgerufen.
     * <p>
     * Extra-Info fuer Nerds: nur in der aktuellen Szene! EDU Games agieren in
     * der Regel nur innerhalb einer Scene ("Hauptszene"). Du kannst aber
     ...
     *
     * @param zoom Zoom-Faktor: &gt;1 vergroessert ; &lt;1 (aber &gt;0)
     *     verkleinert
     */
     ...
     *
     * @return aktueller Zoom-Wert der Kamera: &gt;1 vergroessert ; &lt;1 (aber
     *     &gt;0) verkleinert
     */
