...
{
    private RECHTECK boden, wand, deckel, links1, links2, links3, rechts1, rechts2, rechts3, mitte;
    ...
    /**
     * Wirkt einen Impuls (Kraftstoss) auf den Spieler aus, wenn dieser steht. Kann z.B. zum
     * seitlichen Gleiten und zum Springen genutzt werden.
     *
    ...
    {
        return (this.kugel1.beruehrt(this.spieler) || this.kugel2.beruehrt(this.spieler));
    }
     ...
     *
     * @param sekunden Zeit in Sekunden zwischen den Ticks (z.B. 9.05 fuer 5 Hundertstel Sekunden)
     */
