...
public class DREIECK extends Dreieck
{
    ...
    /**
     * Konstruktor der Klasse <code>DREIECK</code>. Erstellt ein neues Dreieck mit gegebenen
     * Eck-Koordinaten. Die Reihenfolge der Ecken ist egal.
     *
     ...
     * <b>ACHTUNG!</b><br />
     * Dies ist <i>nicht</i> der geometrische Mittelpunkt. Denkt man sich ein Rechteck, das man
     * "genau ueber das Dreieck" spannt, sodass es dieses gerade von allen Seiten umschliesst, so
     * ist der Mittelpunkt <b>dieses Rechtecks</b> der, der hier neu gesetzt wird.
     *
    ...
    /**
     * Verschiebt dieses Dreieck um eine gewisse Strecke - angegeben durch ein "Delta X" und "Delta
     * Y" (in Bildschirm-Metern).
     *
    ...
    /**
     * Diese Methode gibt die x-Koordinate des Mittelpunkts dieses Dreiecks (in Bildschrim-Metern)
     * zurueck.
     *
    ...
    /**
     * Diese Methode gibt die y-Koordinate des Mittelpunkts dieses Dreiecks (in Bildschrim-Metern)
     * zurueck.
     *
    ...
    /**
     * Diese Methode prueft, wie weit der Mittelpunkt dieses Dreiecks vom Mittelpunkt eines anderen
     * Grafik-Objekts in x-Richtung (in Bildschrim-Metern) entfernt ist.
     *
     * @param grafikObjekt Das andere Grafik-Objekt
     *
     * @return Abstand (in Bildschrim-Metern) dieses Dreiecks vom anderen Grafik-Objekt in
     *         x-Richtung (>0, wenn dieses Rechteck rechts des anderen Grafik-Objekts liegt)
     */
    ...
    /**
     * Diese Methode prueft, wie weit der Mittelpunkt dieses Dreiecks vom Mittelpunkt eines anderen
     * Grafik-Objekts in y-Richtung (in Bildschrim-Metern) entfernt ist.
     *
     * @param grafikObjekt Das andere Grafik-Objekt
     *
     * @return Abstand (in Bildschrim-Metern) dieses Dreiecks vom anderen Grafik-Objekt in
     *         y-Richtung (>0, wenn dieses Dreieck unterhalb des anderen Grafik-Objekts liegt)
     */
