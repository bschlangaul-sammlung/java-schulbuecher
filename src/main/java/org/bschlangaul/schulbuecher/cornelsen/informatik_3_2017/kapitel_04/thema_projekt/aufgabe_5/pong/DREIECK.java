...
public class DREIECK extends Dreieck
{
    ...
    /**
     * Konstruktor der Klasse <code>DREIECK</code>. Erstellt ein neues
     * Standard-Dreieck.
     */
    public DREIECK()
    {
     ...
     * mit gegebenen Eck-Koordinaten. Die Reihenfolge der Ecken ist egal.
     *
     ...
     *                    dieser Methode dieses Dreieck sichtbar. Ist dieser
     *                    Wert <code>false</code>, so ist nach dem Aufruf dieser
     *                    Methode dieses Dreieck unsichtbar.
     */
     ...
     *
     * @return Abstand (in Bildschrim-Metern) dieses Dreiecks vom anderen
     *         Grafik-Objekt in y-Richtung (>0, wenn dieses Dreieck unterhalb
     *         des anderen Grafik-Objekts liegt)
     */
