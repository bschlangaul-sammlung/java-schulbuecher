package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_01.thema_05.aufgabe_00.liste_mit_interface;
...
class Knoten
{
     ...
     */
    Knoten(Datenelement dNeu, Knoten kNeu)
    {
        daten = dNeu;
        nachfolger = kNeu;
    }
     ...
     */
    Knoten EinfügenVor(Datenelement dneu, Datenelement d_vergleich)
    {
