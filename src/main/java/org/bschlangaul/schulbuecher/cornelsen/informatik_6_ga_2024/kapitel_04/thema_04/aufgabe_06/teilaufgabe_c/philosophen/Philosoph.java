package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_04.thema_04.aufgabe_06.teilaufgabe_c.philosophen;
...
class Philosoph extends Thread
{
     ...
     * nimmt nach einer Zeit des Denkens erst die Gabel mit einer niedrigeren
     * Id, dann die mit einer höheren Id auf, isst und legt dann beide wieder
     * ab.
     */
    @Override
    public void run()
    {
        while (true)
        {
            ...
            if (gabelRechts.IdGeben() > gabelLinks.IdGeben())
            {
