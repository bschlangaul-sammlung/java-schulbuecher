package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_03.thema_02.aufgabe_11.coaches;
...
/**
 * Ermittelt günstige Paarungen von Coaches und Kandidaten für den
 * Songwettbewerb
 *
...
class Songwettbewerb
{
    ...
    /**
     * Das Feld der zugeordneten Coaches (-1 bedeutert, dass dem Kandidaten noch
     * kein Coach zugeordnet wurde)
     */
     ...
     * @param kandidatenWunschlisteCoaches Wunschlisten der Kandidaten für ihre
     *     Coaches
     * @param coachesWunschlisteKandidaten Wunschlisten der Coaches für ihre
     *     Kandidaten
     *
     * @return wahr, wenn das Lesen erfolgreich war
     */
    private boolean Lesen(String name,
            ArrayList<ArrayList<Integer>> kandidatenWunschlisteCoaches,
            ArrayList<ArrayList<Integer>> coachesWunschlisteKandidaten)
    {
        try
        {
    ...
    /**
     * Sucht für den angegebenen Kandidaten den Coach, den der Kandidat mit dem
     * gegebenen Wunschwert haben möchte)
     *
    ...
    /**
     * Testet, ob die Aufstellung nach Hinzufügen des Paares Kandidat/Coach
     * stabil bleibt
     *
    ...
    private boolean BleibtStabil(int aktuellerKandidat, int aktuellerCoach)
    {
        ...
        {
            if (coachFürKandidat.contains(coach)) // sonst ist der Coach noch
                                                  // frei
            {
    ...
    private void SchrittAusführen(int kandidat)
    {
        for (int wunschwert = anzahl; wunschwert >= 1; wunschwert -= 1)
        {
            ...
            if ((!coachFürKandidat.contains(coach))
                    && BleibtStabil(kandidat, coach))
            {
