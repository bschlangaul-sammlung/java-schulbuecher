package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_02.thema_05.aufgabe_03.addressbuch_visualisierung;
...
class Knoten extends Baumelement
{
    ...
    Knoten(Adressbucheintrag datenNeu)
    {
        ...
        knotenSymbol = new KnotenSymbol(100, 100, 40, "cyan",
    ...
    /**
     * Fügt ein Datenelement (Adressbucheintrag), falls sein Schlüssel noch
     ...
     */
    @Override
    Baumelement Einfügen(Adressbucheintrag datenNeu)
    {
    ...
    /**
     * Sucht ein Datenelement (Adressbucheintrag), das über seinen Schlüssel
     * identifiziert wird und gibt dieses aus.
     *
     * @param suchSchlüssel Schlüssel nach dem gesucht wird als Zeichenkette
     *
     * @return gesuchtes Datenelement (Adressbucheintrag) bzw. null, falls die
     *     Suche erfolglos ist
     */
    @Override
