package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_01.thema_06.aufgabe_00.warteschlange_mit_liste;
...
class Darstellung
{
     ...
     *
     * @param wNeu die darzustellende Warteschlange
     */
    Darstellung(Warteschlange wNeu)
    {
        w = wNeu;
    ...
    void Anzeigen()
    {
        ListenelementAnzeigen(w.AnfangGeben(), 0);
    }
    ...
    public static void main(String[] args)
    {
        ...
        Patient patient1 = new Patient("Hugo");
        Patient patient2 = new Patient("Emil");
        Patient patient3 = new Patient("Kasimir");
        wartesch1.Einfügen(patient1);
        wartesch1.Einfügen(patient2);
        wartesch1.Einfügen(patient3);
        Darstellung darstell1 = new Darstellung(wartesch1);
        darstell1.Anzeigen();
        Patient patient4 = new Patient("Nummer4");
        Patient patient5 = new Patient("Nummer5");
        Patient patient6 = new Patient("Nummer6");
        Patient patient7 = new Patient("Nummer7");
        Patient patient8 = new Patient("Nummer8");
