package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_03.thema_02.aufgabe_05.teilaufgabe_b.springer;
    ...
    void SchrittAusführen(int zeile, int spalte, int nummer)
    {
        ...
        if (nummer == schachbrett.size() * schachbrett.size())
        {
            ...
            for (int pos = 0; pos < 8; pos += 1)
            {
                ...
                if ((aktZeile == yStart) && (aktSpalte == xStart))
                {
                    geschlossen = true;
                }
            }
