...
class User
{
    ...
    /**
     * Gibt den Schlüssel des Datenelements zu Kontrollzwecken auf das
     * Terminalfenster aus.
     */
    ...
    /**
     * Gibt alle Information über das Datenelement zu Kontrollzwecken auf das
     * Terminalfenster aus.
     */
    void InformationAusgeben2()
    {
        System.out.println("Der User " + vorname + " " + nachname + " ist "
                + alter + " Jahre alt.");
    }
     ...
     *     Zeichenketten-Objekt lexikografisch vor dem Eingabewert liegt. Das
     *     Ergebnis ist eine positive ganze Zahl, das ausführende
     *     Zeichenketten-Objekt lexikografisch hinter dem Eingabewert liegt. Das
     *     Ergebnis ist 0, wenn die Zeichenketten gleich sind;
     *
     */
