...
abstract class Baumelement
{
     ...
     */
    abstract Baumelement Einfügen(Adressbucheintrag datenNeu);
     ...
     */
    abstract Adressbucheintrag Suchen(String suchSchlüssel);
     ...
     */
    abstract void KnotenZeichnen(int xmin, int xmax, int y, int dy,
