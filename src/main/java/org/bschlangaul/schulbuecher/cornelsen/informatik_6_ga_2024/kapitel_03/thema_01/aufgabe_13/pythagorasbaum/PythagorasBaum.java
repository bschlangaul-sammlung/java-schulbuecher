package org.bschlangaul.schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_03.thema_01.aufgabe_13.pythagorasbaum;
...
class PythagorasBaum
{
     ...
     */
    private int RichtungGeben(double xStart, double yStart, double xZiel,
            double yZiel)
    {
     ...
     */
    private double LängeGeben(double xStart, double yStart, double xZiel,
            double yZiel)
    {
        double dx = xZiel - xStart;
        double dy = yZiel - yStart;
     ...
     */
    private void DreieckZeichnen(double ax, double ay, double bx, double by,
            double cx, double cy)
    {
     ...
     */
    private void ViereckZeichnen(double ax, double ay, double bx, double by,
     ...
     * @param tiefe die Rekursionstiefe
     */
    private void SchrittAusführen(double ax, double ay, double bx, double by,
            int tiefe)
    {
        if (tiefe > 0)
        {
