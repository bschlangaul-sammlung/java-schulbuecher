...
public class Bild
{
     ...
     * Bilder muessen im Unterordner "Bilder" in fortgeschrittene Grafik liegen.
     */
    public Bild()
    {
        this(null);
    ...
    /**
     * Es wird eine neue Grafik mit den Standardeinstellungen erzeugt. Das Fenster, an dem die
     * Grafik angemeldet wird, kann dabei angegeben werden. Dazu muss zuerst ein Zeichenfenster
     * erzeugt worden sein. Dieses kann dann "waehrend des Konstruktoraufrufs eingefuellt" werden.
     * Aufpunkt: (0, 0) - linke obere Ecke des ueberdeckenden Rechtecks. Das Standardbild ist eine
     * Tulpe, sie wird angezeigt. Bilder muessen im Unterordner "Bilder" in fortgeschrittene Grafik
     * liegen.
     */
    public Bild(Zeichenfenster fenster)
    {// uh
        einfachegrafikAnmelden(this, fortgeschrittenesFensterGeben(fenster));// uh
        org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.eps.fortgeschrittene_grafik.Bild fg =
                        (org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.eps.fortgeschrittene_grafik.Bild) fortgeschrittenegrafikGeben(
                                        this);
        wirdAngezeigt = false;
     ...
     * Projekts) liegen. Es koennen die Formate png und jpg und gif dargestellt werden. Der
     * Unterordner "Bilder/" wird nach der Eingabe automatisch ergaenzt, er darf nicht mit angegeben
     * werden. Der Dienst gibt ggf. Fehlermeldungen auf der Standardkonsole an den Benutzer aus.
     *
    ...
    public String bilderGeben()
    {
        String ergebnis = "";
        String[] dateiliste =
                        org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.eps.fortgeschrittene_grafik.Bild
                                        .bilderGeben();
    ...
    /**
     * Breite und Hoehe des Bildes koennen gewaehlt werden. Nicht positive (unsinnige) Angaben
