package org.bschlangaul.schulbuecher.paetec.informatik_10_2008.eps.werkzeuge;
 ...
 * Beim Erzeugen eines Warteschlangenobjekts muss man angeben, von welchem Typ
 * die aufzubewahrenden Objekte sein werden.
 * <p>
 * Hinweis: Fuer weiterfuehrende Arbeit mit dieser Klasse kann man das Attribut
 * einfacheRepraesentation, weiter die Methode
...
public class Warteschlange<Typ>
{
    ...
    /**
     * Dieser Dienst ermoeglicht es, ein Element des Typs am Ende der Schlange
     * einzureihen. Engl.: addLast
     */
    ...
    /**
     * Dieser Dienst erm�glicht das "Anschauen" des ersten Elements in der
     * Schlange. Das "angeschaute" Element bleibt in der Schlange, es wird nicht
     ...
     *
     * schauen() ist ein sondierender Dienst. Der Inhalt der Schlange (genauer:
     * der Zustand der Schlange) wird nicht veraendert.
     */
    public Typ schauen()
    {// peek
        if (speicher.isEmpty())
    ...
    /**
     * Berechnet die Anzahl der Elemente in der Schlange. Ausgabe: die Anzahl
     * der Elemente
     */
     ...
     * Dienst toString, den jedes Objekt anbietet) ab. Er traegt den Namen, der
     * in Java "vorgesehen ist" und nicht "inhaltsuebersichtGeben". <BR>
