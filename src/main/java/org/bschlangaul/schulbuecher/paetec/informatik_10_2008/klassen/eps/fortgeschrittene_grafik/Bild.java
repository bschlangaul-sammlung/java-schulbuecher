...
public class Bild extends Grafik
{
     ...
     * Zeichenfenster angemeldet. Wird null eingegeben, wird das Standardfenster
    ...
    /**
     * Es wird ein neues Bild mit den Standardeinstellungen erzeugt. Dieses kann
     * mit einem Zeichenfensterobjekt verbunden werden und dort sogleich
     * angemeldet werden (-> in den Eingangsparameter anmelden true
     * hineinfuellen) oder nicht (-> in den Eingangsparameter anmelden false
     * hineinfuellen). Wird null in den Eingangsparameter fenster eingefuellt,
     * so wird das Standardfenster verwendet.
     */
     ...
     * oder "Tulpe.png".
     * <p>
     * Achtung: Die neue Bilddatei wird in Orginalgroesse dargestellt! Die Werte
     * der Attribute breite und hoehe werden entsprechend aktualisiert. Nur die
     * Position (linke obere Ecke des achsenparallelen ueberdeckenden Rechtecks)
     * bleibt erhalten. Alle bisherigen Drehungen, Streckungen (und
     * Veraenderungen der Groesse via groesseSetzen) werden durch das Setzen
     * eines neuen Dateinamens geloescht.
     */
     ...
     * auf dem Zeichenfenster zu sehen. Bei einem vorher evt. aufgetretenen
     * Bildfehler wird der Aufruf von groesseSetzen ignoriert (ein nicht
     * existierende Bild kann auch nicht in der Groesse veraendert werden).
     */
