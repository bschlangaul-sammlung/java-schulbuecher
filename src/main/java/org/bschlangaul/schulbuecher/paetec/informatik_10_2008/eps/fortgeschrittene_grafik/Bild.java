...
public class Bild extends Grafik
{
    ...
    public Bild(boolean anmelden, Zeichenfenster fenster)
    {
        ...
        dateiname = "Tulpe.png";
        internesBild = org.bschlangaul.schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.BildSpeicher
    ...
    {
        Image bild = org.bschlangaul.schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.BildSpeicher
    ...
    public static String[] bilderGeben()
    {
        URL u = Bild.class.getResource(
                org.bschlangaul.schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.BildSpeicher.ordnerpfad);
        ...
        while (it.hasNext())
        {
            if (!org.bschlangaul.schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.BildSpeicher
