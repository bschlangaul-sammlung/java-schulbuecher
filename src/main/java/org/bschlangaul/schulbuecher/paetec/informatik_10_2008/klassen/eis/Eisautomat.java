package org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.eis;

/**
 * An diesem Eisautomat koennen Kunden fuer 80 Cent ein Eis am Stiel kaufen. Der Automat akzeptiert
 * nur 20-Cent-Muenzen. Er bietet die Eissorten "Aloe Vera", "Ananas" und "Apfelsine" an. Erst wenn
 * der Kunde eine Eissorte gewaehlt hat und mehr als vier Muenzen in den Eisautomat geworfen hat,
 * erhaelt er Eis und Restgeld zurueck. Eine Muenze entspricht einem 20 Cent-Stueck.
 *
...
public class Eisautomat
{
    ...
    /**
     * Der Automat bietet die Eissorten "Aloe Vera", "Ananas" und "Apfelsine" an.
     */
    public void eissorteWaehlen(String neueEissorte)
    {
        ...
        if (anzahlDerMuenzen >= 4)
        {
            ...
            anzahlDerMuenzen = 0;
            System.out.println("Sie erhalten ein " + eissorte + "-Eis. Rueckgeld: " + rueckgeld * 20
                            + " Cent");
            eissorte = "nicht gewaehlt";
        }
    }
