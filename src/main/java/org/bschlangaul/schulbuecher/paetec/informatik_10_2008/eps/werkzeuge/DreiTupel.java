 ...
 * Werte zurueckgeben moechte. Alle Komponenten koennen hoechstens einmal mit
 * einem Wert belegt werden. Komponenten wurden veröffentlicht, um diese leicht
 * auslesen zu koennen. Hier liegt keine Verletzung des Geheimnisprinzips vor.
 * Das zu verstehen ist jedoch nicht Lernziel der 10.Klasse. Deshalb bietet die
 * Klasse DreiTupel zusaetzlich noch Dienste zum Auslesen der Komponenten an. So
 * muss in der 10.Klasse nicht thematisiert werden, warum nur im speziellen Fall
 * der Klasse DreiTupel, ein Zugriff auf Attribute erlaubt ist.
 * <p>
