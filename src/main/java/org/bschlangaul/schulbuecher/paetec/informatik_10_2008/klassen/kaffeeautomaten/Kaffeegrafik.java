...
public class Kaffeegrafik
{
    ...
    /**
     * Zeigt den vom Nutzer uebergebenen Geldbetrag in Cent im Display an. Das Display hat nur 4
     * Stellen fuer Ziffern. Wird ein groesserer Geldbetrag angegeben, werden nur die letzten 4
