package org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.sammelleidenschaft;

import java.util.Collection;
import java.util.Iterator;

import org.bschlangaul.schulbuecher.paetec.informatik_10_2008.klassen.sammelleidenschaft.interna.Speicher;
...
public class Behaelter<Typ> extends Speicher<Typ> implements Iterable<Typ>
{
    ...
    /**
     * Erzeugt einen Behaelter, der die Elemente der angegebenen Collection enthaelt. Die Elemente
     * der Collection muessen alle den festgelegten Typ haben.
     */
    ...
    /**
     * nur fuer interessierte veröffentlichen Dieser Dienst fuellt die Elemente aus einem anderen
     * Behaelter in diesen Behaelter hinein, sofern jeweils noch kein gleiches darinnen ist. Engl.:
     * addAll
     */
    ...
    /**
     * nur fuer interessierte veröffentlichen Versucht die Elemente des eingegebenen Behaelters aus
     * diesem Behaelter (man sagt salopp auch "aus uns") zu entfernen. Auch hier ist entscheidend,
     * wie die Gleichheit zweier Elemente festgelegt wurde. "Gleiche Elemente werden entfernt."
     * Mengendifferenz. Engl.: removeAll Ausgabe: true, wenn wenigstens ein Element entfernt werden
    ...
    // Das macht man am besten mit einem Dienst, dessen Namen von Java festgelegt ist.
    // Ab Kapitel 5 kann angesprochen werden, dass equals von Object hier ueberschrieben wird.
