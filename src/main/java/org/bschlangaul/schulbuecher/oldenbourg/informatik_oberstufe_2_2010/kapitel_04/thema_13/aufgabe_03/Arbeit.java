...
/**
 * Baut eine Adjazenzmatrix entsprechend der Aufgabe 3 in Kapitel 13 im Buch Informatik Oberstufe 2
 * Oldenbourg Verlag auf und ermöglicht den Laufzeitvergleich zwischen Brute-Force-Suche und
 * Dijkstra-Algorithmus sowie je eine Messreihe für die beiden Algorithmen bei wachsender Knotenzahl
 * der Graphen.
 *
...
public class Arbeit
{
    ...
    /**
     * Führt sämtliche Arbeiten zur Implementierung des Graphen abhängig von der eingegebenen
     * Knotenanzahl aus: Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der
     * Kanten Maximal sind 22 Knoten möglich, aber es können auch weitere im Code hinzugefügt
     * werden. Die Kanten werden nur dann eingefügt, wenn die beiden Endknoten Teil des Graphen
     * sind.
     *
     * @param knotenzahl Anzahl der Knoten des Graphen (Werte zwischen 1 und 22, falls nicht weitere
     *        Knoten ergänzt werden)
     *
     */
    ...
    /**
     * Führt für das Brute-Force-Verfahren eine Messreihe bei wachsender Knotenzahl (Werte z. Zt.
     * von 1 bis 22) durch. Jeder Messwert entsteht aus 10000-facher Durchführung und
     * Minimumsbestimmung.
     */
    ...
    /**
     * Führt für das Dijkstra-Verfahren eine Messreihe bei wachsender Knotenzahl (Werte z. Zt. von 1
     * bis 22) durch. Jeder Messwert entsteht aus 10000-facher Durchführung und Minimumsbestimmung.
     */
    ...
    /**
     * Vergleicht bei gegebener Knotenzahl die Laufzeit des Dijkstra-Algorithmus mit der des
     * Brute-Force-Verfahrens. Die Laufzeitmessung erfolgt als Minimumsbestimmmung nach 10000-facher
     * Durchführung.
     *
     */
    public void LaufzeitVergleichen(int knotenzahl)
    {
        ...
        System.out.println("Suche aller Wege (Brute Force): " + minLaufzeit + " Nanosekunden");
        ...
        System.out.println("Suche kürzester Weg nach Dijkstra: " + minLaufzeit + " Nanosekunden");
    }
