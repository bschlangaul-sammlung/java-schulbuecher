package org.bschlangaul.schulbuecher.oldenbourg.informatik_oberstufe_1_2009.kapitel_03.thema_12.aufgabe_05.graph_matrix;
...
public class GRAPH_MATRIX
{
    ...
    /**
     * Besucht einen Knoten und besucht dann alle von diesem Knoten ausgehenden Kanten sofern diese
     * noch nicht besucht wurden.
     *
     * @param knotenNummer Knotennummer des zu besuchenden Knotens
     *
     */
    private void BesuchenMitKanten(int knotenNummer)
    {
        ...
        for (int abzweigNummer = 0; abzweigNummer < anzahlKnoten; abzweigNummer++)
        {
            ...
            if ((matrix[knotenNummer][abzweigNummer] > 0) && !(besucht[abzweigNummer]))
            {
                ...
                BesuchenMitKanten(abzweigNummer);
                System.out.println(knoten[abzweigNummer].BezeichnungGeben() + "/"
