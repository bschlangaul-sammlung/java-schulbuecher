...
class FENSTER extends Frame
{
    ...
    /** Knopf zur Ausgabe des nächste Patienten f&umml;r Dr. Eiche */
    private Button ausgabeknopfEiche = new Button();

    /** Knopf zur Ausgabe des nächste Patienten f&umml;r Dr. Buche */
    private Button ausgabeknopfBuche = new Button();

    /** Label zur Ausgabe des nächste Patienten f&umml;r Dr. Linde */
    private Label ausgabeLinde = new Label();

    /** Label zur Ausgabe des nächste Patienten f&umml;r Dr. Eiche */
