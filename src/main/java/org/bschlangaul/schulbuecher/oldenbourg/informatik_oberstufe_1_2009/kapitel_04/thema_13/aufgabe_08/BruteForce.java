package org.bschlangaul.schulbuecher.oldenbourg.informatik_oberstufe_1_2009.kapitel_04.thema_13.aufgabe_08;
...
public class BruteForce
{
     ...
     * @param fNeu Fenster
     */
    public BruteForce(char[] zeichenvorratNeu, int maxlenNeu, String passwortNeu, Fenster fNeu)
    {
    ...
    /**
     * Untersucht alle Passwörter bis zur gewünschten Länge Ausgehend vom Wert des Parameters werden
     * jeweils die Buchstaben des Alphabets angehängt und darauf getestet, ob der entstandene String
     * identisch mit dem Passwort sind. Für den entstandenen String erfolgt der rekursive Aufruf der
     * Methode.
     *
