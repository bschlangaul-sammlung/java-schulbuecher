...
class BAHNHOF implements DATENELEMENT
{
    ...
    /**
     * Setzt die Nummer des Bahnhofs.
     *
     * @param n Bahnhofsnummer
     */
    void NummerSetzen(int n)
    {
        nummer = n;
    }

    /**
     * Setzt die Daten des Bahnhofs.
     *
     * @param n Bahnhofsname
     * @param x x-Koordinate des Bahnhofs
     * @param y y-Koordinate des Bahnhofs
     */
    void DatenSetzen(String n, int x, int y)
    {
        name = n;
        this.x = x;
        this.y = y;
