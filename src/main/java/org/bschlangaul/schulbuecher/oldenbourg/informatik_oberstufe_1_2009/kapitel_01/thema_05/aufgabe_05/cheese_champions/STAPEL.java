...
/**
 * Beschreibung des Stapels überschreibt die nicht benötigten Methoden der Liste.
 *
...
class STAPEL extends LISTE
{
    ...
    /**
     * Entfernt einen Knoten mit einem bestimmten Datenelement aus der Liste <br>
     * Ohne Funktion für den Stapel, deshalb überschrieben
     *
    ...
    /**
     * Entfernt den letzten Knoten aus der Liste und gibt sein Datenelement aus. <br>
     * Ohne Funktion für den Stapel, deshalb überschrieben
     *
    ...
    /**
     * Sucht ein Datenelement, das über seinen Schlüssel identifiziert wird, und gibt es aus. <br>
     * Ohne Funktion für den Stapel, deshalb überschrieben
     *
