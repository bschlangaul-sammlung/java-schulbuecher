...
class FAHRBAHN
{
    ...
    FAHRBAHN(AMPEL a)
    {
        ...
        ampel = a;
        /*
         * fahrzeuge = new FAHRZEUG [30]; for (int i = 0; i < fahrzeuge. length; i++) { fahrzeuge
         * [i] = null; }
         */
        anfang = null;
        ende = null;
    ...
    {
        /*
         * if (fahrzeuge [fahrzeuge. length - 1] == null) { int i; i = 0; while (fahrzeuge [i] !=
         * null) { i = i + 1; } fahrzeuge [i] = f; }
         */
        if (ende != null)
        {
    ...
    void FahrzeugeBewegen()
    {
        ...
        /*
         * for (int i = 0; i < fahrzeuge. length; i++) { if (fahrzeuge [i] != null) { if (i == 0) {
         * wegmax = 100000; vvorg = 100; } else { vvorg = fahrzeuge [i - 1]. GeschwindigkeitGeben
         * (); switch (ausrichtung) { case 'O': wegmax = fahrzeuge [i - 1]. XKoordinateGeben () -
         * fahrzeuge [i]. XKoordinateGeben () - fahrzeuge [i]. LaengeGeben () - vvorg * 1.8f; break;
         * case 'W': wegmax = fahrzeuge [i]. XKoordinateGeben () - fahrzeuge [i - 1].
         * XKoordinateGeben () - fahrzeuge [i - 1]. LaengeGeben () - vvorg * 1.8f; break; case 'N':
         * wegmax = fahrzeuge [i]. YKoordinateGeben () - fahrzeuge [i - 1]. YKoordinateGeben () -
         * fahrzeuge [i - 1]. LaengeGeben () - vvorg * 1.8f; break; case 'S': wegmax = fahrzeuge [i
         * - 1]. YKoordinateGeben () - fahrzeuge [i]. YKoordinateGeben () - fahrzeuge [i].
         * LaengeGeben () - vvorg * 1.8f; break; default: wegmax = 100000; } } switch (ausrichtung)
         * { case 'O': ampelAbstand = darstellung. HaltelinienPositionGeben () - fahrzeuge [i].
         * XKoordinateGeben () - fahrzeuge [i]. LaengeGeben (); break; case 'W': ampelAbstand =
         * fahrzeuge [i]. XKoordinateGeben () - darstellung. HaltelinienPositionGeben (); break;
         * case 'N': ampelAbstand = fahrzeuge [i]. YKoordinateGeben () - darstellung.
         * HaltelinienPositionGeben (); break; case 'S': ampelAbstand = darstellung.
         * HaltelinienPositionGeben () - fahrzeuge [i]. YKoordinateGeben () - fahrzeuge [i].
         * LaengeGeben (); break; default: ampelAbstand = 100000; } if (VorgaengerZaehlt
         * (ampelAbstand, wegmax, fahrzeuge [i])) { fahrzeuge [i]. Fahren (wegmax, vvorg); } else {
         * fahrzeuge [i]. Fahren (ampelAbstand, 0.0f); } } } if ((fahrzeuge [0] != null) &&
         * IstDraussen (fahrzeuge [0])) { fahrzeuge [0]. Entfernen (); for (int i = 1; i <
         * fahrzeuge. length; i++) { fahrzeuge [i - 1] = fahrzeuge [i]; } fahrzeuge [fahrzeuge.
         * length - 1] = null; }
         */
    }
