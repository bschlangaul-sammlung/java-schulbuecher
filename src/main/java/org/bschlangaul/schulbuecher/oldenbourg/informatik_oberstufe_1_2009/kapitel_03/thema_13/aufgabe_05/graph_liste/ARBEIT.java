...
/**
 * Baut Adjazenzlisten entsprechend der Aufgabe 4 in Kapitel 11 auf
 * Buch Informatik Oberstufe 1 Oldenbourg Verlag
 *
 * @author U.Freiberger
 * @version 1.0
 */
...
public class ARBEIT
{
     ...
     * entsprechend der Vorgabe in der Teilaufgabe Autobahn aus
     ...
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
     * ggf. Aufruf der Wegesuche (evtl. auskommentieren)
     * ggf. Aufruf der Suche nach dem kürzesten Weg (evtl. auskommentieren)
     *
     */
     ...
     *
     * führt sämtliche Arbeiten zur Implementierung des Graphen
     * entsprechend der Vorgabe in der Teilaufgabe Flugroute aus
     * Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der Kanten
     *
     * Am Ende Ausgabe der Adjazenzlisten zur Kontrolle
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
    ...
    {
        // Erzeugen eines Graphenobjekts g mit Adjazenzenlisten
        GRAPH_LISTE g = new GRAPH_LISTE();
        ...
        g.Ausgeben();
        g.TiefenSuche("MUC");
        g.WegeSuchen("TXL","GRU");
        g.KuerzesterWeg("TXL","GRU");
    }
     ...
     *
     * führt sämtliche Arbeiten zur Implementierung des Graphen
     * entsprechend der Vorgabe in der Teilaufgabe ICE-Verbindungen aus
     * Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der Kanten
     *
     * Am Ende Ausgabe der Adjazenzlisten zur Kontrolle
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
     ...
     *
     * führt sämtliche Arbeiten zur Implementierung des Graphen
     * entsprechend der Vorgabe in der Teilaufgabe Autobahnkartenausschnitt aus:
     * Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der Kanten
     *
     * Am Ende Ausgabe der Adjazenzlisten zur Kontrolle
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
     ...
     *
     * führt sämtliche Arbeiten zur Implementierung des Graphen
     * entsprechend der Vorgabe in der Teilaufgabe S- und U-Bahn-Verbindungen aus:
     * Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der Kanten
     *
     * Am Ende Ausgabe der Adjazenzlisten zur Kontrolle
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
    ...
    public void AusfuehrenSUBahn()
    {
        ...
        g.WegeSuchen("Herrsching","Flughafen");
     ...
     *
     * führt sämtliche Arbeiten zur Implementierung des Graphen
     * entsprechend der Vorgabe in der Aufgabe Irrgarten aus:
     * Instanzieren des Graphenobjekts; Einfügen der Knoten und Einfügen der Kanten
     *
     * Am Ende Ausgabe der Adjazenzlisten zur Kontrolle
     * ggf. Aufruf der Tiefensuche (evtl. auskommentieren)
     ...
     */
     public void AusfuehrenIrrgarten()
     {
        ...
        g.KanteEinfuegen("J","M",1);
        g.KanteEinfuegen("K","M",1);
        g.KanteEinfuegen("L","N",1);
