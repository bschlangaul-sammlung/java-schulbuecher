...
public class KNOTEN
{
     ...
     * Zeichenkette) hat. Eine überprüfung, ob der Schlüssel in der Baumstruktur vorhanden ist,
     * erfolgt in der Klasse BINBAUM. Die Methode Entfernen überprüt, welcher der folgenden 3 Fälle
     * vorliegt und ruft dann zum eigentlichen Entfernen entweder die Methode Entfernen2 auf bzw.
     * gibt die Aufforderung zum Entfernen an den linken oder rechten Nachbarn weiter. 1. Fall: Der
     * eigene Schlüssel ist grö&szlig;er als der suchSchluessel --> Entfernen im rechten Teilbaum
     ...
     * entfernenden Wert --> Knoten wird mit Hilfe der Methode Entfernen2 entfernt.
     *
     * @param suchSchluessel Schl&uumlssel nach dem gesucht wird als Zeichenkette
    ...
    {
        // 1. Fall: Der eigene Schlüssel ist grö&szlig;er als der suchSchluessel
    ...
    /**
     * Gibt den Baum Preorder auf der Konsole aus und visualisiert dabei die Struktur (ohne null)
     * durch einrücken.
     */
    ...
    /**
     * Gibt den Baum Preorder auf der Konsole aus und visualisiert dabei die Struktur (mit null)
     * durch einrücken.
     */
