 ...
 * Kompositum: Die Klasse legt ausschließlich die Schnittstelle für die Klassen KNOTEN und ABSCHLUSS
 * in Form von Methoden fest.
 *
...
abstract class BAUMELEMENT
{
     ...
     *
     * @return (neues) Nachfolgeelement des Aufrufers, null falls es kein Datenelement mit dem
     *         eingegebenen Schlüssel gibt
     */
     ...
     */
    public abstract int HoeheGeben(int aktTiefe);
