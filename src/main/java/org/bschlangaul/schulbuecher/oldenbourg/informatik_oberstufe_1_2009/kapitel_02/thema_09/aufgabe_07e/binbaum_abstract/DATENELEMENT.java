...
/**
 * Das Interface DATENELEMENT dient als Schnittstelle zum Speichern von Daten in rekursiven
 * Datenstrukturen. Jedes Datenelement hat ein Schlüsselattribut, auf das eine Ordnungsrelation
 * festgelegt ist Es werden vergleichende Methoden wie IstGleich und IstKleiner ähnlich wie im Java
 * Interface Comperable festgelegt, die für Such- und sortierte Einfügeoperationen in die
...
public interface DATENELEMENT
{
     ...
     * @return true, wenn das aktuelle Element einen kleineren Schlüssel hat, als das eingegebene
     *         Datenelement dvergleich.
     */
     ...
     *         eingegebene Datenelement dvergleich.
     */
    ...
    /**
     * Gibt den Wert Schlüssel als String zurück. Diese allgemeine Methode ist nötig, da in den von
     * DATENELEMENT abgeleiteten Klassen nicht ein allgemeines Attribut schluessel vom Typ String
     * existiert, sondern Name und Datentyp Schlüssels frei gewählt werden kann. Diese Methode wird
     * beim Entfernen eines Knotens benötigt.
     *
