...
public class GRAPH_MATRIX
{
    ...
    GRAPH_MATRIX(int maxAnzahlKnoten)
    {
        ...
        //Die Adjazenzmatrix wird mit den Werten 0 auf der Diagonalen und sonst mit den Werten -1 vorbelegt.
    ...
    ****************************************************************************************************/
    ...
    void kanteLoeschen(int start, int ziel)
    {
        ...
        {
            System.out.println("Es wurde keine Kante gelöscht, da Start- oder Zielknoten nicht existieren.");
        }
    }
   ...
   int KnotenHinzufuegen(DATENELEMENT inhalt)
    ...
    void KnotenLoeschen(int knotenIndex)
    {
        ...
        {
            //Alle Feldelemente des Knotenfeldes ab dem zu löschenden Knoten werden eine Stelle nach vorne gerückt.
        ...
        anzahlKnoten = anzahlKnoten - 1;
        System.out.println("Es wurde der Knoten mit der Nummer " + knotenIndex + " gelöscht.");
    }
