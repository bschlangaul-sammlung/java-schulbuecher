...
public class RANGIERBAHNHOF
{
    ...
    */
    ...
    /**
     * führt den Rangiervorgang aus
     * Dabei muss nur überprüft werden, aus welches Zielgleis der Waggon gesetzt werden soll.
    */
   void Rangieren()
    {
     ...
     /**
     * gibt die Anzahl der Waggons auf dem gewüschten Gleis aus
     * Dabei muss nur überprüft werden, aus welches Zielgleis der Waggon gesetzt werden soll.
     * Aufgabe c i
    ...
    */
    void AnzahlWaggonGeben(int gleisnummer) {
        int anzahl = 0;
        switch (gleisnummer) {
            case 1: anzahl = gleis1.AnzahlGeben(); break;
            case 2: anzahl = gleis2.AnzahlGeben(); break;
            case 3: anzahl = gleis3.AnzahlGeben(); break;
            // Fehlerfall:
            default: anzahl = -1;
        }
     ...
     /**
     * sucht einen Waggon mit der gew&uum;schten Waggonnummer und gibt ggf. die Nummer des Gleises aus, auf dem dieser Waggon steht
     * Die Methode nutzt Methode Suchen von STAPEL bzw. LISTE
     * Aufgabe c ii
    ...
    void WaggonSuchen(int waggonnummer)
    {
        ...
        if (gleis1.Suchen(waggon)) {
            ...
            if (gleis2.Suchen(waggon)) {
                System.out.println("Gesuchter Waggon " + waggonnummer + " befindet sich auf Gleis 2");
            } else {
                    if (gleis3.Suchen(waggon)) {
                        System.out.println("Gesuchter Waggon " + waggonnummer + " befindet sich auf Gleis 3");
                    } else {
                        System.out.println("Gesuchter Waggon " + waggonnummer + " ist nicht vorhanden!");
                    }
            }
        }
    }
     ...
     /**
     * bestimmt die Anzahl der Waggons des vorgegebenen Typs auf einem bestimmten Gleis
     * Aufgabe c iii
    ...
    */
    void AnzahlWaggontypGeben(int gleisnummer, char typ)
    {
        ...
        switch (gleisnummer) {
            case 1: anzahl = gleis1.AnzahlmitEigenschaftGeben(waggon); break;
            case 2: anzahl = gleis2.AnzahlmitEigenschaftGeben(waggon); break;
            case 3: anzahl = gleis3.AnzahlmitEigenschaftGeben(waggon); break;
            // Fehlerfall:
            default: anzahl = -1;
        }
