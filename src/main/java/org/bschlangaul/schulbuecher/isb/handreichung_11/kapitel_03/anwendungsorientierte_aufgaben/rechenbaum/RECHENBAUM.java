...
class RECHENBAUM
{
    ...
    */
    ...
    /**
     *  wandelt den in Postfixnotation abgespeicherten Term in einen Rechenbaum um.
     *  Der Rechenbaum wird als Baum abgespeichert
     */
    void InBaumUmwandeln() {
        ...
        while (zeichenposition < term.length()) {
            // Momentan untersuchtes Zeichen der Zeichenkette termInPostfixnotation
          ...
          switch (zeichen)
            {
              ...
              case '+': case '-': case '/': case '*':
                 // Erzeuge einen neuen Baum mit der Wurzel, die das Zeichen z verwaltet
                 z = new ZEICHEN(zeichen);
                 neuerbaum = new BAUM(z);
                 // Haenge an den neuen Baum die zwei obersten Teilbaeume, die im Stapel zwischengespeichert sind
                 ...
                 break;
              // Ansonsten muss das Zeichen eine Zahl (oder evtl. auch eine Variable) sein...
              default:
                 z = new ZEICHEN(zeichen);
                 // Erzeuge einen neuen Baum mit der Wurzel, die das Zeichen z verwaltet
                 neuerbaum = new BAUM(z);
    ...
    // Aufgabe 3
     /**
     * macht einen Inorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der Konsole aus.
        */
    void TermInInorderAusgeben() {
       ...
       /**
     * macht einen Postorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der Konsole aus.
        */
     void TermInPostorderAusgeben() {
      ...
      /**
     * macht einen Preorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der Konsole aus.
        */
