...
class RECHENBAUM
{
    ...
    /**
     * wandelt den in Postfixnotation abgespeicherten Term in einen Rechenbaum um. Der Rechenbaum
     * wird als Baum abgespeichert
     */
        ...
        while (zeichenposition < term.length())
        {
            ...
            switch (zeichen)
            {
                ...
                case '*':
                    ...
                    // Haenge an den neuen Baum die zwei obersten Teilbaeume, die im Stapel
    ...
    // Aufgabe 3
    /**
     * macht einen Inorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der
     * Konsole aus.
     */
    ...
    /**
     * macht einen Postorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der
     * Konsole aus.
     */
    ...
    /**
     * macht einen Preorder-Durchlauf durch den Rechenbaum mit Inorder und gibt die Zeichen auf der
     * Konsole aus.
     */
