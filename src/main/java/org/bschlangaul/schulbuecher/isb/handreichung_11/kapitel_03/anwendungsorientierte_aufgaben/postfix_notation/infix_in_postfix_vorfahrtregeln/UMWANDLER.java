...
class UMWANDLER
{
    ...
    */
     void UmwandelnInInfixnotation() {
        ...
        while (zeichenposition < term.length()) {
            ...
            switch (zeichen)
            {
              ...
              case '+': case '-': case '/': case '*':
                 // und der Stapel leer ODER das Zeichen von hoeherem Rang als das oberste Zeichen auf dem Stapel
                 if (RechenzeichenIstHoeher(zeichen) || stapel.IstLeer()) {
                     z = new ZEICHEN(zeichen);
                     stapel.Einfuegen(z);
                  } else {
                      // und das Zeichen von gleichem oder niedrigerem Rang als das oberste Zeichen auf dem Stapel
     ...
     * Die Methode ist sehr kurz, wenn man mit logischen operatoren arbeitet
