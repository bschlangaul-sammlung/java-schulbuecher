...
/**
 * The test class TESTDURCHLAUF.
 *
 * @author (your name)
 * @version (a version number or a date)
 */
public class TESTDURCHLAUF extends junit.framework.TestCase
{
    /**
     * Default constructor for test class TESTDURCHLAUF
     */
    public TESTDURCHLAUF()
    {
    }
