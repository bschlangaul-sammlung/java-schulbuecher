...
class FLUGNETZ_GERICHTET {
    // Attribute
    private GRAPH_MATRIX flugnetz;

    //Konstruktor
    FLUGNETZ_GERICHTET() {
            flugnetz = new GRAPH_MATRIX(10);
            FlughaefenAnlegen();
    ...
    // Methoden
    /**
     * Hilfsmethode zum Füllen des Knoten-Feldes
     *  Die Belegung des Knotenfeldes erfolgt in der Reihenfolge der Nr., die in der Tabelle gegeben ist. Damit stimmen Feldindex und Flughafennr überein.
    */
    ...
    */
    private void FlugverbindungenAnlegen(){
        ...
        FlugverbindungHinzufuegen(2, 0, 212);
        FlugverbindungHinzufuegen(2, 4, 695);
        FlugverbindungHinzufuegen(1, 2, 545);
        FlugverbindungHinzufuegen(1, 3, 313);
        FlugverbindungHinzufuegen(3, 4, 433);
        FlugverbindungHinzufuegen(5, 6, 155);
        FlugverbindungHinzufuegen(6, 5, 155);
     }

     /**
      *  Aufgabe 2
      *  Hinzufuegen eines neuen Flughafens
      *  Ausgenuetzt wird dabei die Methode knotenHinzufuegen(DATENELEMENT inhalt) der Klasse  GRAPH_MATRIX
     */
    ...
    /**
     * Aufgabe 2
     * Hinzufuegen einer neuen Flugverbindung
     * Ausgenuetzt wird dabei die Methode kanteHinzufügen(int start, int ziel, int bewertung) der Klasse  GRAPH_MATRIX
     * Es wird davon ausgegangen, dass es sich immer um bidirektionale Verbindungen handelt!
     */
    void FlugverbindungHinzufuegen(int startflughafennr, int zielflughafennr, int entfernung) {
        flugnetz.KanteHinzufügen(startflughafennr, zielflughafennr, entfernung);
    }

    /**
     * Aufgabe 3: Suchen der Flughaefen mit Bahnanbindung
     * Es reicht hier, das Flughafen-Feld zu untersuchen
    */
     ...
     * Ausgenutzt wird hierbei, dass die Adjazenzmatrix symmetrisch ist. Alle "Direktverbindungen" sind aufgrund der Entfernungseinträge
     * in der Zeile i (i Index des Ausgangsflughafens) bzw. der Spalte i ersichtlich. Es reicht, entweder die entsprechende Zeile oder Spalte abzuprüfen!
    */
    ...
    /**
     * Aufgabe 5: Suchen der Flughaefen, die von einem durch die Flughafennummer gegebenen Flughafen aus (irgendwie) erreichbar sind
     * Idee zur Umsetzung: Tiefensuche
    */
    ...
    /**
     * Aufgabe 6: Anwenderfreundlichere Version der Methode DirektverbindungSuchen durch Eingabe des Flughafennamens
     * Es wird aus Einfachheitsgruenden davon ausgegangen, dass der übergebene Flughafenname existiert!
    */
    public void DirektverbindungSuchen(String flughafenname) {
        DirektverbindungSuchen(NameFuerIndexSuchen(flughafenname));
    }
    /**
     * Hilfsmethode, die zu einem gegebenen Flughafennamen die Flughafennummer, also den Index des Knotens, der den Flughafen verwaltet, sucht
     */
