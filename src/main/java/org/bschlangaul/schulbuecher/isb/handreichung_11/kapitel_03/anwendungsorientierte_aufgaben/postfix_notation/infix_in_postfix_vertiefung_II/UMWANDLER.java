...
class UMWANDLER
{
    ...
    // Methoden
    /**
     * Eingabe eines Terms als String in Infix-Notation
     * Aus Einfachheitsgründen sind nur die Zahlen 0 bis 9 bzw. einbuchstabige Variablen zulässig!
   ...
   void TermInInfixNotationEingeben(String term) {
     ...
     /**
     * Eingabe eines Terms als String in Postfix-Notation
     * Aus Einfachheitsgründen sind nur die Zahlen 0 bis 9 bzw. einbuchstabige Variablen zulässig!
     * Methode ist nützlich bei Vertiefungsaufgabe 2
   ...
   void TermInPostfixnotationEingeben(String term) {
     ...
     /**
     * Umwandlung des in termInInfixnotation abgespeicherten Terms in die Postfix-Notation und Abspeicherung des Ergebnisses in termInPostfixnotation
     * Berüsichtigt ist nun der Rang des Rechenzeichens, d.h. Punkt vor Strich und gleichwertige Rechenzeichen von links nach rechts
    */
     void InInfixnotationUmwandeln() {
        String term = termInInfixnotation;
        termInPostfixnotation ="";
        ZEICHEN z, oberstesZeichen;
        // Lokale Hilfsvariable für die Abspeicherung des Indexes des momentan betrachteten Zeichens von termInInfixnotation
        ...
        while (zeichenposition < term.length()) {
            ...
            switch (zeichen)
            {
              ...
              case '+': case '-': case '/': case '*':
                     ...
                     if (RechenzeichenrangIstHoeher(zeichen)) {
                        ...
                        stapel.Einfuegen(z);
                          ...
                          if(OberstesZeichenIstRechenzeichen()) {
                                ...
                                termInPostfixnotation = termInPostfixnotation + oberstesZeichen.WertGeben();
                          }
                          // Solange das oberste Zeichen ein hoeherrangiges Rechenzeichen ist ...
                          while (!stapel.IstLeer() && !RechenzeichenrangIstHoeher(zeichen) && OberstesZeichenIstRechenzeichen()) {
                                oberstesZeichen = (ZEICHEN) stapel.Entfernen();
                                termInPostfixnotation = termInPostfixnotation + oberstesZeichen.WertGeben();
                          }
                 ...
                 break;
              // Ist das Zeichen eine schließende Klammer, so nimm solange Zeichen vom Stack und hänge sie an die Zeichenkette term_in_postfixnotation, bis eine öffende Klammer oben auf dem Stack liegt
              case ')':
    ...
    /** prüft, ob das übergebene Rechenzeichen einen höheren Rang hat als das Zeichen, das ganz oben auf dem Stapel liegt
     * Es handelt sich um eine interne Hilfsmethode
     * Es wird ebenfalls true zurückgegeben, wenn der Stapel leer ist, weil das auch als Höherrangigkeit des übergebenen Rechenzeichens interpretiert werden kann
     * Die Methode ist private gesetzt, da sie nur zur interne Prüfung notwendig ist
     ...
     */
     private boolean RechenzeichenrangIstHoeher(char zeichen) {
        ...
        // falls zeichen * oder / und das oberste Element + und -, liegt Hoeherrangigkeit vor, ansonsten nicht
        return  ((zeichen == '*' || zeichen == '/') && (oberstesElement.WertGeben() == '+' || oberstesElement.WertGeben() == '-'));
     }

    /** prüft, ob das oberste Zeichen des Stapels ein Rechenzeichen oder nicht (d.h. es muss sich dann um eine Klammer handeln) ist
     * Es handelt sich um eine interne Hilfsmethode
    */
        ...
        while (zeichenposition < term.length()) {
            ...
            switch (zeichen)
            {
              ...
              case '+': case '-': case '/': case '*':
                 ...
                 // Operand ist als Charakter abgespeichert und muss deshalb richtig "konvertiert" werden.
                 if (zeichen == '+') {
              ...
              default:
              //  Konvertierung char --> int liefert ASCII-Code; Subtraktion des ASCII-Codes des Zeichens '0' liefert die "richtige" Konvertierung
