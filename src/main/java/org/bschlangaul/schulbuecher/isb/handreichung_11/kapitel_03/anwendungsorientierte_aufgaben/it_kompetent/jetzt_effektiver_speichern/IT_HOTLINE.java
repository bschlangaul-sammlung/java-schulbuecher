...
class IT_HOTLINE
{
     ...
     * @param Kundennummer und Problemschilderung
     * 'Wir begrü&szig;en Sie bei der Hotline von IT-Kompetent. Geben Sie bitte Ihre Kundennummer sowie eine Kurzbeschreibung Ihres Problems an.' */
     ...
     * Zu den Informationen gehören (im Vergleich zu Aufgabenvorschlag 1) nicht nur die Anruferdaten, sondern auch die Kundendaten!
     */
    ...
    /**
     * bestimmt die Anzahl der Anrufer, die sich momentan in der Warteschlange befinden und zeigt diese auf der Konsole an
     */
    void AnzahlDerAnruferHolen() {
         System.out.println("Momentane Anzahl der Anrufer in der Warteschleife: " + anruferschlange.AnzahlGeben());
         System.out.println("----------------------------------------------------");
    }
    ...
    /**
    * dient zum Suchen eines Kunden (-Objekts) über die Kundennummer
    * Der Kunde muss dabei nicht unbedingt vorhanden sein
    * @param Kundennummer
    ...
    * Aus Einfachheitsgründen wird davon ausgegangen, dass der durch die übergebene Kundennummer festgelegte Kunde existiert
    * @param Kundennummer
    */
    void SchulnameAendern(int kundennummer, String neuerSchulname) {
     ...
     /**
    * gibt die Kundendaten nach der Kundennummer geordnet aus
    * es muss nur der inorder-Durchlauf genutzt werden.
    * @param Kundennummer
    */
