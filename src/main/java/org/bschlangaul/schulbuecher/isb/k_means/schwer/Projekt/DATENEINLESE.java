...
public class DATENEINLESE
{
     ...
     * sich im selben Verzeichnis, wie das BlueJ-Projekt befinden.
     */
    public static PUNKT [] ladeTrainingsdaten(String Dateiname){
        ...
        try (Scanner scanner = new Scanner(file)) {
            ...
            JOptionPane.showMessageDialog(null,"Die konnte leider nicht gelesen werden.");
        }

        JOptionPane.showMessageDialog(null,"Es wurden Trainingsdaten mit " + Datensatz.size() + " Datenpunkten eingelesen");
