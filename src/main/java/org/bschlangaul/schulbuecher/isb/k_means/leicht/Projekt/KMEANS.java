...
public class KMEANS
{
    ...
    public boolean aktualisiereClusterzuordnung(){
        ...
        // !!! Hier ergänzen !!!
        for(int i = 0;               ; i++){
            // Bestimme den Index des nächstgelegenenen Zentrums zum aktuell betrachteten
            // Datenpunkt und speichere diesen lokal
            // !!! Hier ergänzen !!!

            // Falls die Nummmer des Zentrums, dem dieser Datenpunkt zugeodnet ist nicht mit
            // dem berechneten Index (+1 da wir die Zentren beginnend mit 1 nummerieren)
            // übereinstimmt:
            // Aktualisiere die Zurodnung und belege die Variable gleichbleibend entsprechend
            // !!! Hier ergänzen !!!
