package org.bschlangaul.schulbuecher.isb.handreichung_12.kapitel_02.zusaetzliches_projekt_02.maximale_clientanzahl_liste;
 ...
 * Dieser Server lässt nur eine bestimmte Anzahl an Clients zu. Der Zugriff auf die Ressourde
 * clientanzahl ist <b>noch nicht synchronisiert!</b>
 *
...
public class SERVERZ4
{
    ...
    /**
     * wartet auf eine neue Verbindung und lagert diese, falls möglich, in einen Thread aus.<br/>
     * Ist die maximal mögliche Anzahl der Verbindungen erreicht, so wird die Clientverbindung
     * kurzzeitig hergestellt um das Stoppsignal Server[stopClient] für den Client zu senden.
     */
    ...
    /**
     * fügt einen Clientprozess falls die maximale Clientanzahl noch nicht erreicht ist. Ist die
     * maximal mögliche Anzahl der Verbindungen erreicht, so wird die Clientverbindung kurzzeitig
     * hergestellt um das Stoppsignal Server[stopClient] für den Client zu senden. In dieser Version
     * <b>synchronisiert!</b>
     *
     * @param clientSocket der Socket über den der Clientprozess kommunizieren soll
     */
    private synchronized void ClientProzessHinzufuegen(Socket clientSocket) throws IOException
    {
        ...
        else
        {
            ...
            System.out.println("zu viele Verbindungen, Clientverbindung wird zurueckgesetzt");
        }
    }

    /**
     * entfernt einen Clientprozess aus der Liste der Clientprozesse In dieser Version
     * synchronisiert!</b>
     *
     * @param clientprozess der Clientprozess, der aus der Liste entfernt werden soll.
     */
    public synchronized void ClientProzessEntfernen(CLIENTPROZESSZ1 clientprozess)
    {
