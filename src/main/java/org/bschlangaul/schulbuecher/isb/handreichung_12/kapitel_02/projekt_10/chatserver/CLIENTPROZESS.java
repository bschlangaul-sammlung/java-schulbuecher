 ...
 * Clientverbindung<br/>
 * - über die Startbotschaft, die im Konstruktor übergeben wird, kann das Senden des Stoppsignals
 * für den Client veranlasst werden.<br/>
...
class CLIENTPROZESS extends Thread
{
    ...
    /**
     * Konstante für den Zustand angemeldet (in der clientprozessliste des Servers aufgenommen) des
     * Threads
     */
     ...
     * @param server Referenz auf den Server, wird beim Beenden des Prozesses benötigt.
     * @param startbotschaft ist die Startbotschaft gleich "toomuchclients" so wird das
     *        Clientstopsignal gesendet.
     */
    public CLIENTPROZESS(Socket clientSocket, CHATSERVER server, String startbotschaft)
                    throws IOException
    {
    ...
    /**
     * Verbindung herstellen, falls die Startbotschaft "toomuchclients" lautet, wird das
     * Beendensignal an den Client gesendet! der Thread wird in diesem Fall nicht vom Server
     * gestartet und braucht deshalb auch nicht beendet werden.
     *
     * @param startbotschaft
     */
    public void ClientVerbindungStarten(String startbotschaft) throws IOException
    {
