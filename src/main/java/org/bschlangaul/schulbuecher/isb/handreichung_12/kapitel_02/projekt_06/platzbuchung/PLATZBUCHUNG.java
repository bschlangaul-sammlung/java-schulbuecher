package org.bschlangaul.schulbuecher.isb.handreichung_12.kapitel_02.projekt_06.platzbuchung;
...
public class PLATZBUCHUNG
{
     ...
     *
     * @param server der Platzbuchungsserver, dessen Methoden PlaetzeVerfuegbar() und
     ...
     * übermittelt wurde, nimmt Platzbuchung vor.
     *
        ...
        switch (zustand)
        {
            ...
            case angefragt:
                if (textvomclient.equalsIgnoreCase("buche"))
                {
                    ...
                    {
                        ausgabe = "konnte leider nicht buchen, " + "Platz nicht mehr verfuegbar.";
                    }
                    zustand = wartend;
                }
