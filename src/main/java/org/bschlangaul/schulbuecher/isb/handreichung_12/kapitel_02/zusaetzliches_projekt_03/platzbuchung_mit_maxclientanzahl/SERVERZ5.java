 ...
 * Dieser Server lässt nur eine bestimmte Anzahl an Clients zu. Die Prozesse der verbundenen Clients
 * werden in einer Liste verwaltet. Es können Plätze gebucht werden.
 *
...
public class SERVERZ5
{
    ...
    private synchronized void ClientProzessHinzufuegen(Socket clientSocket) throws IOException
    {
        ...
        if (clientprozesse.size() < maximaleclientanzahl)
        {
            ...
            CLIENTPROZESSZ2 clientprozess = new CLIENTPROZESSZ2(clientSocket, this, "");
            clientprozess.start();
     ...
     */
    public synchronized void ClientProzessEntfernen(CLIENTPROZESSZ2 clientprozess)
    {
