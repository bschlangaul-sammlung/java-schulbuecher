 ...
 * Die Stellen, an denen eine Quelltextergänzung notwendig ist, sind mit "Quelltextergänzung"
 * gekennzeichnet.
 *
...
public class WETTERVERHALTEN2
{
    ...
    private String[] wetter = {"Regen, 4\u00B0C, 996mbar", "Sonne, 24\u00B0C, 1050mbar",
                    "leicht bew\u00F6lkt, 15\u00B0C, 1013mbar", "Schneeregen, -2\u00B0C, 997mbar"};

    /**
     * ermittelt, ob Wetterdaten für die angegebene Stadt vorhanden sind
     *
     * @param gesuchteStadt Name der Stadt, für die nach Wetterdaten gesucht wird
    ...
    /**
     * ermittelt die zu sendende Antwort in Abhängigkeit des Zustands und des Textes, der vom Client
     * übermittelt wurde
     *
     * @param textvomclient der Text, der vom Client an den Server gesendet wurde.
    ...
    public String HoleAntwort(String textvomclient)
    {
        ...
        /*
         * Quelltextergänzung: unabhängig vom Zustand bei textvomclient == "beenden" immer antworten
         * "Server[stopClient]: Auf Wiedersehen!"
         */
        ...
        switch (zustand)
        {
            ...
            case stadtgefragt:
                ...
                ausgabe = ausgabe + " Wollen Sie eine weitere Stadt abfragen? (Ja)?";
                zustand = nochmal;
                break;
            ...
            case nochmal:
                ...
                {
                    /* Quelltextergänzung, hier will der Client beenden. */
                    zustand = wartend;
                }
                break;
        }
