 ...
 * Clientverbindung<br/>
 * über die Startbotschaft, die im Konstruktor übergeben wird, kann das Senden des Stoppsignals für
 * den Client veranlasst werden.
 *
...
class CLIENTPROZESSZ1 extends Thread
{
     ...
     * wird zum Beenden des Clientprozesses gebraucht um die Methode ClientProzessEntfernen() des
     * Servers aufzurufen.
     */
     ...
     */
    public CLIENTPROZESSZ1(Socket clientSocket, SERVERZ4 server, String startbotschaft)
                    throws IOException
    {
     ...
     */
    private void ClientVerbindungStarten(String startbotschaft) throws IOException
    {
