package schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_04.thema_03.aufgabe_04.vorlage;
...
class Stegverwaltung
{
     ...
     */
    void PlatzReservieren(Boot bootAn)
    {
        while (bootanzahl >= 10)
        {
     ...
     */
    void PlatzFreigeben(Boot bootAb)
    {
        boote.remove(bootAb);
        bootanzahl -= 1;
