...
class GraphListe
{
    ...
    void KanteEinfügen(String von, String nach, int gewichtung)
    {
        ...
        {
            vonKnoten.AdjazenzlisteGeben()
                .add(new Kante(gewichtung, nachKnoten));
            nachKnoten.AdjazenzlisteGeben()
                .add(new Kante(gewichtung, vonKnoten));
            kanten.add(new KantenSymbol(vonKnoten.SymbolGeben(),
                    nachKnoten.SymbolGeben(), false, "" + gewichtung, 3,
                    "blau"));
        }
    }
