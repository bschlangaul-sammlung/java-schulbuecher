package schulbuecher.cornelsen.informatik_6_ga_2024.kapitel_03.thema_04.aufgabe_05.vertreter2;
...
class GraphMatrix
{
     ...
     */
    void KnotenBesuchen(int aktuell, int länge)
    {
    ...
    void TiefensucheAusführen(int startKnoten)
    {
        ...
        optimalerWeg.clear();
        optimaleLänge = Integer.MAX_VALUE;
        KnotenBesuchen(startKnoten, 0);
        for (Integer i : optimalerWeg)
        {
            knoten.get(i).FarbeSetzen("grün");
        }
    }
}
