 ...
 * @version 1.0
 */
class KnotenListe extends Listenelement
{
    /**
     ...
     */
    KnotenListe(Patient dNeu, Listenelement lNeu)
    {
        daten = dNeu;
        nachfolger = lNeu;
    }
     ...
     */
    @Override
    KnotenListe HintenEinfügen(Patient dNeu)
    {
     ...
     */
    @Override
    KnotenListe EinfügenVor(Patient dNeu, Patient dVergleich)
    {
        if (daten == dVergleich)
        {
     ...
     */
    @Override
    KnotenListe SortiertEinfügen(Patient dNeu)
    {
