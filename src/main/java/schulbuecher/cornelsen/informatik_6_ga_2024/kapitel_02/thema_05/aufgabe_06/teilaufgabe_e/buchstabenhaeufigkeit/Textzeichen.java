...
/**
 * Die Klasse Textzeichen dient zur Speicherung von Textzeichen und deren
 * absolute Häufigkeit (in einem Text).
 *
...
class Textzeichen
{
    ...
    /**
     * Konstruktor für Objekte der Klasse Textzeichen Die Anzahl wird auf 1
     * gesetzt, da es das erste Auftreten des Textzeichens ist.
     *
     * @param zeichenNeu derBuchstabe.
     */
    ...
    /**
     * Vergleicht zwei Datenelemente bezüglich der Ordnungsrelation. Durch die
     * Methode SchlüsselAlsStringGeben() wird das Zeichen in eine Zeichenkette
     * für den Vergleich umgewandelt.
     *
     * @param dvergleich Datenelement mit dem das Objekt verglichen wird.
     *
     ...
     * Gleichheit. Durch die Methode SchlüsselAlsStringGeben() wird das Zeichen
     * in eine Zeichenkette für den Vergleich umgewandelt.
     *
     ...
     * Ordnungsrelation. Durch die Methode SchlüsselAlsStringGeben() wird das
     * Zeichen in eine Zeichenkette für den Vergleich umgewandelt.
     *
     * @param vergleichsSchlüssel Schlüssel mit dem der Schlüssel des Objekt
     *     verglichen wird.
     *
     ...
     * Datentyp vom Durch die Methode SchluesselAlsStringGeben() wird das
     * Zeichen in eine Zeichenkette für den Vergleich umgewandelt. String
