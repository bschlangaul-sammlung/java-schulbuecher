...
class Knoten extends Baumelement
{
     ...
     */
    @Override
    Baumelement Einfügen(Textzeichen datenNeu)
    {
        // Falls es das Zeichen schon gibt, Anzahl um eins erhöhen.
     ...
     */
    @Override
    Textzeichen Suchen(String suchSchlüssel)
    {
