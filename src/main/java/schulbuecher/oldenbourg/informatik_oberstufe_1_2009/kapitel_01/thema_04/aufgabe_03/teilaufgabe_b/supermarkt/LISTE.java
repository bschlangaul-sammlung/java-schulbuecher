...
class LISTE
{
    ...
    /**
     * Sorgt für das NeuPositionieren der Darstellungssymbole der Listenelemente
     *
     * @param knummer Nummer der Kasse
     */
    void NeuPositionieren(int knummer)
    {
        anfang.NeuPositionieren(knummer, 0);
    }

    /**
     * Ausgabe der Artikelzahl der Liste
     *
     * @return Artikelzahl
     */
    int ArtikelzahlGeben()
    {
        return anfang.ArtikelzahlGeben();
    }
}
