 ...
 * @version (20.07.08)
 */
public class WorterbuchEintrag implements DatenElement
{
    /**
     ...
     *
     */
    public WorterbuchEintrag(String wortNeu, String bedeutungNeu)
    {
        wort = wortNeu;
    ...
    public boolean IstKleinerAls(DatenElement dvergleich)
    {
        ...
        WorterbuchEintrag vergleichsWBE;
        vergleichsWBE = (WorterbuchEintrag) dvergleich;
