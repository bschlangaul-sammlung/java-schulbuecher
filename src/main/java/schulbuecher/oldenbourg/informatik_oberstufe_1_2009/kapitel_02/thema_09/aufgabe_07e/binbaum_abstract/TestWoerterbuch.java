...
public class TestWoerterbuch
{
    ...
    public TestWoerterbuch()
    {
        ...
        woerterbuch.Einfuegen(
            new WoerterbuchEintrag("clip", "Klammer, abschneiden, anstecken"));
        woerterbuch
            .Einfuegen(new WoerterbuchEintrag("car", "Auto, Fahrzeug, Waggon"));
        ...
        woerterbuch
            .Einfuegen(new WoerterbuchEintrag("care", "Fuersorge, Sorgfalt"));
        woerterbuch.Einfuegen(
            new WoerterbuchEintrag("cave", "Hoehle, aushoehlen, einbrechen"));
        woerterbuch.Einfuegen(
