...
public class Text
{
    private schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittenes_formular.Text internerText;
    ...
    public Text()
    {
        internerText = new schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittenes_formular.Text();
    }
