...
import schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.Vektorgrafik;
import schulbuecher.paetec.informatik_10_2008.eps.fortgeschrittene_grafik.interna.Zeichenfenster;
...
public class Text extends Vektorgrafik
{
    ...
    /**
     * Es wird ein neues Textobjekt mit den Standardeinstellungen auf dem
     * Standardfenster erzeugt. Die Schriftgroesse des Textobjekts kann gewaehlt
     * werden. Werden hier unsinnige nicht positive Eingaben gemacht, wird
     * automatisch die kleinste moegliche Schriftgroesse 1 gesetzt. Das
     ...
     * mögliche Schriftgroesse 1 gesetzt. Dieser kann mit einem
     * Zeichenfensterobjekt verbunden werden und dort sogleich angemeldet werden
     * (-> in den Eingangsparameter anmelden true hineinfuellen) oder nicht (->
     * in den Eingangsparameter anmelden false hineinfuellen). Wird null in den
     ...
     * Anfuehrungsstriche beim Datentyp String nicht vergessen! Z.B. "Guten
     * Morgen" Aber es können auch Zahlen (Datentyp int) eingefuellt werden.
     * Z.B. 54 Achtung: Der Inhalt wird in der bei Konstruktion des Textobjekts
     * festgelegten Schriftgroesse dargestellt! Die Werte der Attribute breite
     * und hoehe werden entsprechend aktualisiert. Farbe und Position bleiben
     * jedoch erhalten. Alle Drehungen, Streckungen (und Veraenderungen der
     * Groesse via groesseSetzen) werden durch das Setzen eines neuen Textes
     * geloescht.
     */
    ...
    /**
     * Technische Methode, die Zeichenfensterobjekte nutzen. Die Zeichenkette
     * wird auf dem Zeichenfenster dargestellt, falls das Attribut istAnzuzeigen
