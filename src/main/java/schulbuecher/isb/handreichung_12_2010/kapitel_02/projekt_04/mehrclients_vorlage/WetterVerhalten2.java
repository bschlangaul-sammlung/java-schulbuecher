package schulbuecher.isb.handreichung_12_2010.kapitel_02.projekt_04.mehrclients_vorlage;
...
public class WetterVerhalten2
{
    ...
    public String HoleAntwort(String textvomclient)
    {
        String ausgabe = null;
        /*
         * Quelltextergänzung: unabhängig vom Zustand bei textvomclient ==
         * "beenden" immer antworten "Server[stopClient]: Auf Wiedersehen!"
         */
        switch (zustand)
        {
        case wartend:
