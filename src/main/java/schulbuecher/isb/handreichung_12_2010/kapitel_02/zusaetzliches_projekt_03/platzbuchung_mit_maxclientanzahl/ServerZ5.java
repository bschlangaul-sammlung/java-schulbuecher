package schulbuecher.isb.handreichung_12_2010.kapitel_02.zusaetzliches_projekt_03.platzbuchung_mit_maxclientanzahl;
...
public class ServerZ5
{
     ...
     * kommunizieren.
     */
    private ArrayList<ClientProzess2> clientprozesse = new ArrayList<ClientProzess2>();
            ...
            throws IOException
    {
        ...
        {
            ClientProzess2 clientprozess = new ClientProzess2(clientSocket,
                    this, "");
            clientprozess.start();
