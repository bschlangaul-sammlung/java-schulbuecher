...
class Baer extends Actor
{
    ...
    public void act()
    {
        ...
        /*
         * Wenn du Muell beruehrst, verringere den Punktezaehler. Das
         * Muell-Objekt verschwindet dann.
         */
        if (isTouching(Muell.class))
        {
            zaehler.verringereUm(1);
            removeTouching(Muell.class);
        }
        /*
