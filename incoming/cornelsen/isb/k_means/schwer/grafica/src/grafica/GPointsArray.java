...
public class GPointsArray
{
     ...
     * Constructor
     *
     * @param vectors an array of Processing vectors with the points x and y
     *     coordinates
     * @param labels the points text labels
     */
     ...
     * Constructor
     *
     * @param vectors an arrayList of Processing vectors with the points x and y
     *     coordinates
     */
     ...
     *
     * @param pts the new points. The number of points could differ from the
     *     original.
     */
     ...
     * another point
     *
     * @param index the point index. If the index equals the array size, it will
     ...
     *
     * @param nPoints the new total number of points in the array. It should be
