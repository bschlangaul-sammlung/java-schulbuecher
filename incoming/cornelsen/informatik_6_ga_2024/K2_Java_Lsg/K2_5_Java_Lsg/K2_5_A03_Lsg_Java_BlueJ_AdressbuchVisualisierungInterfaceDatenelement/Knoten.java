...
class Knoten extends Baumelement
{
    ...
    Knoten(Datenelement datenNeu)
    {
        ...
        knotenSymbol = new KnotenSymbol(100, 100, 40, "cyan", daten.SchlüsselAlsStringGeben());
     ...
     */
    @Override Baumelement Einfügen(Datenelement datenNeu)
    {
     ...
     */
    @Override Datenelement Suchen(String suchSchlüssel)
    {
