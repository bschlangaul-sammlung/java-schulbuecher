...
class Knoten extends Baumelement
{
    ...
    Knoten(User datenNeu)
    {
        ...
        knotenSymbol = new KnotenSymbol(100, 100, 25, "cyan", "" + daten.IdGeben());
     ...
     */
    @Override boolean IstVorhanden(int suchSchlüssel)
    {
        if(daten.SchlüsselIstGleich(suchSchlüssel))
        {
            return true;
     ...
     */
    @Override int TiefeGeben(int suchSchlüssel, int tiefe)
    {
        if(daten.SchlüsselIstGleich(suchSchlüssel))
        {
            return tiefe;
