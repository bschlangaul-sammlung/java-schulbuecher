 ...
 * Schlüsselattribut, auf das eine Ordnungsrelation festgelegt ist
 * Es werden vergleichende Methoden wie IstGleich und IstKleiner
 * ähnlich wie im Java Interface Comperable festgelegt, die 
 * für Such- und sortierte Einfügeoperationen in die Datenstrukturen 
 * notwendig sind.
 * 
...
interface Datenelement
{
    ...
    /**
     * Gibt den Wert Schlüssel als String zurück. Diese allgemeine Methode ist nötig, da in den
     * von Datenelement abgeleiteten Klassen nicht ein allgemeines Attribut schluessel vom Typ String
     * existiert, sondern Name und Datentyp Schlüssels frei gewählt werden kann.
     * Diese Methode wird beim Entfernen eines Knotens benötigt.
