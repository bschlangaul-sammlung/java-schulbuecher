...
class Knoten extends Baumelement
{
    ...
    @Override int AnzahlJugendlicheBerechnen()
    {
        ...
        {
            return 1 + rechterNachfolger.AnzahlJugendlicheBerechnen() + linkerNachfolger.AnzahlJugendlicheBerechnen();
        }
        else
        {
            return rechterNachfolger.AnzahlJugendlicheBerechnen() + linkerNachfolger.AnzahlJugendlicheBerechnen();
        }
    }
    ...
    @Override int AnzahlErwachseneBerechnen()
    {
        if(daten.AlterGeben() >=18)
        {
            return 1 + rechterNachfolger.AnzahlErwachseneBerechnen() + linkerNachfolger.AnzahlErwachseneBerechnen();
        }
        else
        {
            return rechterNachfolger.AnzahlErwachseneBerechnen() + linkerNachfolger.AnzahlErwachseneBerechnen();
        }
    }
}